...
exem_1 = int(input('Введите кол-во баллов по русскому языку: '))
exem_2 = int(input('Введите кол-во баллов по математике: '))
exem_3 = int(input('Введите кол-во баллов по информатике: '))
if exem_1 + exem_2 + exem_3 >= 270:
